...
export const ApplicationQuestionsModal = ({ 
  ...
  const fetchAnswers = async () => {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_SERVER_PROTOCOL}://${process.env.REACT_APP_SERVER_IP}/application-questions/${activeTarget.id}/answers`
      );
  ...
  const handleUpdateAnswer = async (answerId) => {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_SERVER_PROTOCOL}://${process.env.REACT_APP_SERVER_IP}/application-questions/answers/${answerId}`,
        {
          method: 'PUT',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify({
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_SERVER_PROTOCOL}://${process.env.REACT_APP_SERVER_IP}/application-questions/answers/${answerToDelete}`,
        {
          method: 'DELETE'
        }
      );
